...
title: Task Management Mode (MCP-Aligned)
description: Structured planning and execution using MCP tools: Sequential Thinking for explicit reasoning, Context7 for up-to-date documentation, and explicit memory artifacts for continuity.
category: devex
