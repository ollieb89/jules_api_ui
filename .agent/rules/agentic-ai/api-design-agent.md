...
description: **Tags:** Agentic AI, API Design, REST, GraphQL, Architecture, Agentic AI, Reasoning, Planning, +3, Agentic AI, Prompt Engineering, LLM, +2, Agentic AI, Debugging, Troubleshooting, +2, AWS, S3, Uploads, UX, Next.js, Error Handling, Performance, Image
---

# 🔌 API Design Agent - RESTful & GraphQL Expert

**Tags:** Agentic AI, API Design, REST, GraphQL, Architecture, Agentic AI, Reasoning, Planning, +3, Agentic AI, Prompt Engineering, LLM, +2, Agentic AI, Debugging, Troubleshooting, +2, AWS, S3, Uploads, UX, Next.js, Error Handling, Performance, Images, Optimization
