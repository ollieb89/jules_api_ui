...
description: You are an expert in Docker and containerization technologies.
---

# Docker & Containerization Expert

**Tags:** Docker, Containers, DevOps, Infrastructure, IaC, Terraform, Pulumi, +2, DevSecOps, Security, Compliance, +1, Kubernetes, K8s, Orchestration, +1, Docker, Cleanup, Disk Space, Database, Postgres, Local Development, DevOps, Terminal, Process
