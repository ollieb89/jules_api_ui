          ...
          <div class="mb-4">
            ...
            <div class="relative">
              ...
              <button
                ...
                class="absolute right-2 top-1/2 -translate-y-1/2 !p-1 !bg-transparent !border-0 text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus-ring)] rounded"
              >
                @if (showApiKey()) {
