          ...
          <div class="mb-4">
            ...
            <div class="relative">
              <input
                ...
                class="w-full px-3 py-2 border border-[var(--color-border-strong)] rounded-lg bg-[var(--color-surface-primary)] text-[var(--color-text-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-focus-ring-offset)] pr-16"
                [style.borderColor]="
              ...
              <button
                ...
                class="absolute right-2 top-1/2 -translate-y-1/2 px-2 py-1 text-xs font-medium !bg-transparent !text-[var(--color-text-secondary)] hover:!text-[var(--color-text-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus-ring)] rounded cursor-pointer !border-none !shadow-none"
              >
