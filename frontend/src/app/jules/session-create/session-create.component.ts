    ...
    <div class="container mx-auto px-4 py-8 max-w-3xl">
      ...
      @if (currentStep() === 1) {
        <div class="bg-[var(--color-surface-primary)] shadow-md rounded-lg p-6" [formGroup]="form">
          ...
          @if (loadingSources()) {
            <div class="flex items-center gap-2 py-2 text-[var(--color-text-secondary)]">
              <app-loading-spinner [sizeClass]="'h-5 w-5'" [containerClass]="''"></app-loading-spinner>
          ...
          <div class="flex justify-end gap-3 mt-6">
            <button
              type="button"
              (click)="cancel()"
              class="!bg-transparent !text-[var(--color-text-secondary)] px-4 py-2 border border-[var(--color-border-default)] rounded-lg hover:bg-[var(--color-surface-secondary)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-focus-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-focus-ring-offset)]"
            >
              Cancel
            </button>
            <button
            ...
            >
              @if (loading()) {
                <div class="flex items-center gap-2">
                  <app-loading-spinner [sizeClass]="'h-4 w-4'" [containerClass]="''" [colorClass]="'text-current'"></app-loading-spinner>
                  <span>Creating...</span>
                </div>
              } @else {
                ✓ Create Session
