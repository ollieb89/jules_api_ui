...
export const routes: Routes = [
  ...
  },
  {
    path: 'dashboard',
    loadComponent: () =>
      import('./jules/dashboard/dashboard.component').then((module) => module.DashboardComponent),
  },
  {
    path: 'users',
    loadComponent: () =>
  ...
  },
  {
    path: 'jules/settings',
    loadComponent: () =>
      import('./jules/settings/settings.component').then((module) => module.SettingsComponent),
  },
  {
    path: 'jules/integrations',
    loadComponent: () =>
      import('./jules/phase-two/phase-two.component').then((module) => module.PhaseTwoComponent),
  },
  {
    path: 'jules/:id',
    loadComponent: () =>
