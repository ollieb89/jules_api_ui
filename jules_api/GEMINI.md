...
This `GEMINI.md` file provides essential context and instructions for AI agents working on the `jules_api` project.

## 1. Project Overview

`jules_api` is a modern Angular frontend application serving as the user interface for the Jules system. It uses Angular 21+, Tailwind CSS 4, and is built for Server-Side Rendering (SSR).
