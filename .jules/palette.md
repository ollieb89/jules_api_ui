...
## 2026-02-21 - Contextual Confirmation Messages
**Learning:** Generic confirmation messages like "Are you sure you want to delete this user?" increase cognitive load and risk of error. Including the entity name (e.g., "Delete Alice Smith?") directly in the dialog text provides immediate verification and reduces accidental deletions.
**Action:** Always include the specific name or identifier of the item being deleted in confirmation dialogs.
